...
Для возможности более гибкой интеграции предусмотрена шаблонизация уведомлений пополнения баланса. Шаблон представляет из себя обыкновенный URL с плейсхолдерами вида `{amount}`, которые будут заменены на соответствующие значения.
